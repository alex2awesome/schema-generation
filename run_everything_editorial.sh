...
INPUT_FILE="experiments/editorial/data/chunks-with-problems.json.gz"
USE_OPENAI=true
...
python src/step_6__agglomerative_clustering.py \
    ...
    --experiment editorials \
    --raw_data_examples_df_path $EXPERIMENT_DIR/models/all_extracted_discourse_with_clusters.csv \
    ...
    --use_discretization \
    --discretization_goal "determine the common argumentation strategy" \
