...
- input_file: Path to the input CSV file with the following columns:
    - 'Narrative Function': Contains the text data for which comparisons will be made.
...
- col_name: Name of the column containing the text data (default: 'Narrative Function').
