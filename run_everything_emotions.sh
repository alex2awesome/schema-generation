...
INPUT_FILE="data/combined_emotions.csv"
USE_OPENAI=true
...
python src/step_6__agglomerative_clustering.py \
    ...
    --experiment $EXPERIMENT_NAME \
    --raw_data_examples_df_path $EXPERIMENT_DIR/data/combined_emotions.csv \
    ...
    --use_discretization \
    --discretization_goal "determine the common emotions of the text" \
